...
import com.ac.cooperativism.api.assembler.VoteInputDisassembler;
import com.ac.cooperativism.api.assembler.VoteModelAssembler;
...
import com.ac.cooperativism.domain.exception.AlreadyVotedException;
import com.ac.cooperativism.domain.exception.ClosedSessionException;
import com.ac.cooperativism.domain.exception.SessionNotOpenedException;
...
import com.ac.cooperativism.domain.repository.VoteRepository;
...
public class VoteServiceImpl implements VoteService {
    ...
    public VoteModel create(String document, VoteInput voteInput) {
        ...
        throw new ClosedSessionException(voteToSave.getTopic().getId());
    }
