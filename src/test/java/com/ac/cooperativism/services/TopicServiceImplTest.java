...
public class TopicServiceImplTest {
    ...
    public void createTopicShouldReturnTopicModel() {
        //given
        TopicInput topicInput = TestUtils.buildCreateTopicInput();
        Topic topicToSave = TestUtils.buildCreateTopic();
        Topic savedTopic = TestUtils.buildTopic();
        TopicModel savedTopicModel = TestUtils.buildTopicModel();
